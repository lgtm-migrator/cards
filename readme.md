...
[![Issue](https://img.shields.io/github/issues/alexrogalskiy/cards)](https://img.shields.io/github/issues/alexrogalskiy/cards)
[![Forks](https://img.shields.io/github/forks/alexrogalskiy/cards)](https://img.shields.io/github/forks/alexrogalskiy/cards)
[![Stars](https://img.shields.io/github/stars/alexrogalskiy/cards)](https://img.shields.io/github/stars/alexrogalskiy/cards)
...
Cards is a serverless dynamically card name based on SVG (Scalable Vector Graphics) which is you can make your own card name and set in your magic readme. For the tech stack, Cards using Typescript and serverless function from Vercel and also this project had been deployed on Vercel.

# How to use this?
It's simple, you can copy paste this markdown content, like this one:

```
![Card](https://cardivo.alexrogalskiy.vercel.app/api?name=[name]&description=[description]&image=[image_url])
```
...
Pattern in Cards, i'm used the [Hero Pattern](https://github.com/lowmess/hero-patterns) package which is developed by [Lowmess](https://github.com/lowmess/), and here the list: 
...
# Example
This is example of using *cards*:
